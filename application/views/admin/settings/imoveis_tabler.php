<?php
/**
 * Configurações de Imóveis - Tabler
 * 
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Configurações de Imóveis</h3>
    ...
    <div class="card-body">
        <form method="post" action="<?php echo base_url('settings/imoveis'); ?>">
...
$data = [
    'content' => $content,
    'page_title' => 'Configurações de Imóveis',
    'active_tab' => 'imoveis'
];
