...
<div class="lg:pl-64 min-h-screen flex flex-col">
    ...
    <header class="bg-white border-b border-gray-200 sticky top-0 z-30">
        <div class="flex items-center justify-between px-4 py-4">
            ...
            <a href="<?php echo base_url('settings/cupons_create'); ?>" class="btn-primary btn-sm">
        ...
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                    ...
                    <a href="<?php echo base_url('settings/cupons_maintenance'); ?>" 
                ...
                <?php if (empty($coupons)): ?>
                    <div class="p-8 text-center text-gray-500">
                        ...
                        <a href="<?php echo base_url('settings/cupons_create'); ?>" class="btn-primary mt-4 inline-block">
                            Criar Cupom
                        </a>
                    </div>
                <?php else: ?>
                                ...
                                <?php foreach ($coupons as $coupon): ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                            <a href="<?php echo base_url('settings/cupons_view/' . $coupon->id); ?>" 
                                            ...
                                            <a href="<?php echo base_url('settings/cupons_edit/' . $coupon->id); ?>" 
                                               class="text-indigo-600 hover:text-indigo-900" title="Editar">
                                                <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                </svg>
                                            </a>
                                            <a href="<?php echo base_url('settings/cupons_toggle/' . $coupon->id); ?>" 
                                            ...
                                            <a href="<?php echo base_url('settings/cupons_delete/' . $coupon->id); ?>" 
