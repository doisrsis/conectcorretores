        ...
        <div class="max-w-7xl mx-auto space-y-6">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3 flex-1">
                            <h3 class="text-sm font-medium text-orange-800">
                                ⚠️ Problema com o Pagamento - Ação Necessária
                            </h3>
                            <div class="mt-2 text-sm text-orange-700">
                                <p class="font-semibold">Seu plano está em período de graça.</p>
                                <p class="mt-1">Não conseguimos processar o pagamento da sua assinatura. Seus imóveis continuam ativos temporariamente, mas você precisa atualizar seu método de pagamento para evitar o cancelamento.</p>
                            </div>
                            <div class="mt-4 flex gap-3">
                                <a href="<?php echo base_url('planos/portal'); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if ($subscription): ?>
                <div class="bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden">
                    <!-- Header com gradiente (cor muda se pendente) -->
                    <div class="bg-gradient-to-r <?php echo $subscription->status === 'pendente' ? 'from-orange-500 to-orange-600' : 'from-green-500 to-emerald-600'; ?> px-6 py-4">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="<?php echo $subscription->status === 'pendente' ? 'text-orange-100' : 'text-green-100'; ?> text-sm font-medium">
                                    <?php echo $subscription->status === 'pendente' ? '⚠️ Seu Plano (Pagamento Pendente)' : 'Seu Plano Atual'; ?>
                                </p>
                            ...
                            <div class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-white/20 text-white backdrop-blur-sm">
                                <?php if ($subscription->status === 'pendente'): ?>
                                ...
                                <?php endif; ?>
                                <?php echo $subscription->status === 'pendente' ? 'Período de Graça' : 'Ativa'; ?>
                            </div>
                        </div>
                    </div>
                    
                    <!-- Aviso de Pagamento Pendente (dentro do card) -->
                    <?php if ($subscription->status === 'pendente'): ?>
                        <div class="bg-orange-50 border-b-2 border-orange-200 px-6 py-4">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-sm font-semibold text-orange-800 mb-1">
                                        Problema com o Pagamento - Ação Necessária
                                    </h4>
                                    <p class="text-sm text-orange-700 mb-3">
                                        Não conseguimos processar o pagamento da sua assinatura. Seus imóveis continuam ativos temporariamente, mas você precisa atualizar seu método de pagamento para evitar o cancelamento.
                                    </p>
                                    <a href="<?php echo base_url('planos/portal'); ?>" class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 transition">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
                                        </svg>
                                        Atualizar Método de Pagamento
